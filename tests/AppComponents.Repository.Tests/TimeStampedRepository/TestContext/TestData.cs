...
{
    public static class TimeStampedRepoTestData
    {
        ...
        public static readonly TimeStampedMockItem NewItem = new TimeStampedMockItem() { Id = 6, Name = "New Item", Value = "New Value" };
        public static readonly TimeStampedMockItem UpdateItem = new TimeStampedMockItem() { Id = 5, Name = "Item 5", Value = "Value 5" };

        public static readonly TimeStampedMockItem FirstDuplicateItem = new TimeStampedMockItem() { Id = 4, Name = DuplicateName, Value = "Value 4" };
        public static readonly TimeStampedMockItem LastDuplicateItem = new TimeStampedMockItem() { Id = 5, Name = DuplicateName, Value = "Value 4" };

        public static readonly List<TimeStampedMockItem> MockItems = new()
        {
            new TimeStampedMockItem { Id = 1, Name = "Item 1", Value = "Value 1" },
            new TimeStampedMockItem { Id = 2, Name = "Item 2", Value = "Value 2" },
            new TimeStampedMockItem { Id = 3, Name = "Item 3", Value = "Value 3" },
            new TimeStampedMockItem { Id = 4, Name = "Item 4", Value = "Value 4" },
            new TimeStampedMockItem { Id = 5, Name = "Item 5", Value = "Value 5" },
        };


        public static readonly List<TimeStampedMockItem> DuplicateMockItems = new()
        {
            new TimeStampedMockItem { Id = 1, Name = "Item 1", Value = "Value 1" },
            new TimeStampedMockItem { Id = 2, Name = "Item 2", Value = "Value 2" },
            new TimeStampedMockItem { Id = 3, Name = "Item 3", Value = "Value 3" },
            new TimeStampedMockItem { Id = 4, Name = DuplicateName, Value = "Value 4" },
            new TimeStampedMockItem { Id = 5, Name = DuplicateName, Value = "Value 5" },
        };

        //public static readonly List<TimeStampedMockItem> MockItemsForPagination = new()
        //{
        ...
        //public static readonly List<TimeStampedMockItem> MockItemsForOrderBy = new()
        //{
        //    new MockItem { Id = 2, Name = "Item 2", Value = "Value 2" },
